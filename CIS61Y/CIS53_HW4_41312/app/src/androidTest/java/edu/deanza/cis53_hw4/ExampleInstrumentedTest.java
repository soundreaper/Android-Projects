...
import edu.deanza.cis53_hw4.data.*;
import edu.deanza.cis53_hw4.data.WeatherContract.LocationEntry;
import edu.deanza.cis53_hw4.data.WeatherContract.WeatherEntry;
/**
...
public class ExampleInstrumentedTest {
    static String APP_TAG = "CIS53";
    @Test
    public void useAppContext() throws Exception {
        // Context of the app under test.
        Context appContext = InstrumentationRegistry.getTargetContext();

        assertEquals("edu.deanza.cis53_hw4", appContext.getPackageName());
    }
    @Test
